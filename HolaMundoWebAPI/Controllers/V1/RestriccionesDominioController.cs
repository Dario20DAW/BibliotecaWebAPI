...
namespace BibliotecaAPI.Controllers.V1
{
    ...
    public class RestriccionesDominioController : ControllerBase
    {
        ...
        [HttpPost]
        public async Task<ActionResult> Post(RestriccionDominioCrearDTO restriccionDominioCreacionDTO)
        {
        ...
        public async Task<ActionResult> Post(int id,
            RestriccionDominioActualizarDTO restriccionDominioActualizacionDTO)
        {
