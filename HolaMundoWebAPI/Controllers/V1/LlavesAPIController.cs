...
namespace BibliotecaAPI.Controladores.V1;
...
public class LlavesAPIController : ControllerBase
{
    ...
    public LlavesAPIController(ApplicationDbContext context,
        IMapper mapper, IServicioLlaves servicioLlaves, IServicioUsuarios serviciosUsuarios)
    {
    ...
    [HttpPost]
    public async Task<ActionResult> Post(LlaveCrearDTO llaveCreacionDTO)
    {
        var usuarioId = serviciosUsuarios.ObtenerUsuarioId()!;
    ...
    [HttpPut("{id:int}")]
    public async Task<ActionResult> Put(int id, LlaveActualizarDTO llaveActualizacionDTO)
    {
        var usuarioId = serviciosUsuarios.ObtenerUsuarioId();
